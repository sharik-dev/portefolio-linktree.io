      ...
      <section ref={downloadRef} className="relative py-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-black tracking-tight text-white mb-2">{ui.downloadTitle}</h2>
            <p className="text-white/40 text-sm max-w-md mx-auto">{ui.downloadSub}</p>
          </motion.div>
            ...
            {DOWNLOAD_SOURCES.map((src, i) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-lg font-black text-white mb-2 tracking-tight">{src.name}</h3>
                  <p className="text-sm text-white/55 leading-relaxed mb-6">{src.desc[lang]}</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((f, i) => (
            <motion.div
              ...
              className="group bg-white/[0.03] border border-white/[0.07] rounded-2xl p-6 hover:bg-white/[0.06] hover:border-[#8B5CF6]/30 transition-all duration-300"
            >
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <div className="relative w-64 md:w-72">
              ...
              <img src={screen2} alt="LocalShort app" className="relative rounded-3xl shadow-2xl border border-white/[0.08] object-cover w-full" />
            </div>
          </motion.div>
        </div>
      </section>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" required value={formState.name}
                    ...
                    className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#8B5CF6]/50 focus:bg-white/[0.06] transition-all" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea required rows={5} value={formState.message}
                  ...
                  className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#8B5CF6]/50 focus:bg-white/[0.06] transition-all resize-none" />
              </div>
